...
public class ImageProdukAdapter extends PagerAdapter {

    private String[] urls;
    private LayoutInflater inflater;
    private Context context;

    public ImageProdukAdapter(Context context, String[] urls) {
    ...
    public Object instantiateItem(ViewGroup view, final int position) {
        View imageLayout = inflater.inflate(R.layout.image_produk, view, false);
